            ...
            <li key={item.id} className="m-0 p-0">
              <article className="group relative flex h-full flex-col overflow-hidden rounded-[var(--pgrl-radius)] border border-solid border-[hsl(var(--pgrl-line))] bg-[hsl(var(--pgrl-surface))] shadow-sm motion-safe:transition-shadow hover:shadow-md">
                {item.imageUrl ? (
                  ...
                  <div
                    aria-hidden
                    className="flex h-40 w-full items-center justify-center bg-[hsl(var(--pgrl-primary))]"
                  >
                ...
                <div className="flex flex-1 flex-col p-5">
                  ...
                  <h3 className="mb-0 mt-3 text-base font-bold leading-snug text-[hsl(var(--pgrl-ink-soft))]">
                    <LandingLink
                      to={item.href}
                      target={external ? "_blank" : undefined}
                      className={
                        "line-clamp-3 !text-inherit no-underline after:absolute after:inset-0 after:content-[''] " +
                        FOCUS_RING
                      }
                    >
                      {item.title}
