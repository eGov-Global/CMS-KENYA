  ...
  return (
    ...
    >
      <CoreAdminUI layout={DigitLayout} dashboard={DigitDashboard}>
        ...
        {/* CCSD-1996: schema-driven Edit/Create kept on role-actions (dedicated List/Show stay). */}
        {canViewResource('role-actions') && <Resource name="role-actions" list={RoleActionList} show={RoleActionShow} edit={MdmsResourceEdit} create={MdmsResourceCreate} />}
        ...
        {/* CCSD-2008: config-driven landing masters — full generic CRUD (the
            ...
            resource, routes and MDMS APIs). Gated like every other resource;
            capability is default-allow outside the access-control allowlist. */}
        {canViewResource('landing-sections') && <Resource name="landing-sections" list={MdmsResourcePage} show={MdmsResourceShow} edit={MdmsResourceEdit} create={MdmsResourceCreate} />}
        {canViewResource('landing-page-config') && <Resource name="landing-page-config" list={MdmsResourcePage} show={MdmsResourceShow} edit={MdmsResourceEdit} create={MdmsResourceCreate} />}
